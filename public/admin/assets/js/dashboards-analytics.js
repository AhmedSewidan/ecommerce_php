...
(function () {
  ...
  //     if (document.querySelectorAll('.myCheckbox:checked').length > 0) {
...
$(document).ready(function() {
  ...
  $('.menu-item').on('focus', function() {
        $(this).toggleClass('menu-item active open');
...
//       $(this).closest('.menu-item').siblings().removeClass('active open');
//     }
//   });
...
//     // Add active class to clicked menu item and its parent menu
//     $menuItem.addClass('active open');
//     $menuItem.siblings().removeClass('active open');

//     // Stop event propagation to prevent submenu from closing
//     e.stopPropagation();
//   });
// });
