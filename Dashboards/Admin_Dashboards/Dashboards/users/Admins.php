...
<div class="card">
  ...
  <div class="table-responsive text-nowrap">
    <form action="../../../../Controllers/deleteManyUsers.php?user_type_id=2" method="post">
        <table class="table">
          <thead>
            <tr>
        ...
        <div class="col-sm-10">
          ...
          <a href="../Forms/AddUser.php?user_type_id=2" id="add" class="btn btn-primary"><strong>+</strong> Add Admin</a>
        </div>
      </form>
  </div>
</div>
