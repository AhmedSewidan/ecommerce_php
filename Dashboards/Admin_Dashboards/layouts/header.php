...
$checkIdExist = $user->allUsersIds($_SESSION['admin']['user_id']);
...
function getImge(){
  global $user;
  if(isset($_SESSION['admin'])){
    $photoData = $user->getPhoto($_SESSION['admin']['user_id']);
    echo '<img src="data:image/jpeg;base64,' . base64_encode($photoData) . '" style="width: 40px; height: 40px; border-radius: 50%;" >';
  }else{ 
    echo '<img src="../../../../public/customer/img/SimpleProfile.jpg" alt class="w-px-40 h-auto rounded-circle" />';
  }
}
?>
...
<html
  ...
  data-assets-path="../../../public/admin/assets/"
  ...
  <head>
    ...
    <link rel="stylesheet" href="../../../../public/admin/assets/css/table.css" />
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-medium d-block"><?php if(isset($_SESSION['admin'])){ echo $_SESSION['admin']['username']; }else{echo 'User';} ?></span>
                    ...
                    <li>
                      <a class="dropdown-item" href="<?php if(isset($_SESSION['admin'])){ echo '../Forms/EditUser.php?id=' .$_SESSION['admin']['user_id']; }else{echo '#';} ?>">
                    ...
                    <li>
                      <a class="dropdown-item" href="../../../login/adminLogin.php">
