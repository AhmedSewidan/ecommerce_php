...
<body>
<div class="container">
    <h1>Login Customers</h1>
    <?php if(isset($_SESSION['endLogin'])){ echo $_SESSION['endLogin'];} ?>

    <form action="../../Controllers/login_request.php?type=1" method="post">
        ...
        <!-- Message -->
        <?php if(isset($_SESSION['MPassword'])){ echo $_SESSION['MPassword'];} unset( $_SESSION['MPassword'], $_SESSION['phone'], $_SESSION['password'], $_SESSION['MPhone'], $_SESSION['endLogin']) ?>
    ...
    <div class="signup-link">
        <a href="adminLogin.php">I'm Admin</a>
    </div>
</div>
